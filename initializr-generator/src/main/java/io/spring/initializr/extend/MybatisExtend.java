...
public class MybatisExtend implements ModuleExtend {
    ...
    public String appPoperties(ProjectRequest request, Map<String, Object> model) {
        return templateRenderer.process("mybatis/application.properties", model);
    }
    ...
    public void javaFile(ProjectRequest request, Map<String, Object> model, ExtendContentCreator.ProjectDir projectDir) {
        ...
        //DO
        fileComponent.mkdir(projectDir.getSrc(), "model").writeFile("UserDO.java", "mybatis/do.java", model);
        //Mapper.xml Mapper.java
        fileComponent.mkdir(projectDir.getSrc(), "dao").writeFile("UserDAO.java", "mybatis/dao.java", model);
        fileComponent.mkdir(projectDir.getResources(), "mybatis/mapper").writeFile("UserDAOMapper.xml", "mybatis/mapper.xml", model);
        ...
        //test
        fileComponent.mkdir(projectDir.getTestSrc(), "dao").writeFile("UserDAOTest.java", "mybatis/test.java", model);
    }
